...
# --- SETTING NASKAH ---
var naskah: Array = [
	"Di Dunia Yang Penuh Dengan Misteri.",
	"Seseorang terbangun di sebuah hutan.",
	"Dunia Ini Penuh Dengan Rintangan",
	"Dan Juga Hal-Hal Yang Aneh",
...
func masuk_ke_game():
	...
	var error = get_tree().change_scene_to_file("res://scene/Sins.tscn")
